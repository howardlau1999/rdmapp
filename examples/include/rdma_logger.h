...
public:
  ...
  static LogStream info() { return LogStream(enabled_.load(), "[INFO]"); }

  static LogStream debug() { return LogStream(enabled_.load(), "[DEBUG]"); }

  static LogStream error() { return LogStream(true, "[ERROR]"); }
