...
class qp : public noncopyable, public std::enable_shared_from_this<qp> {
  ...
  /**
   * @brief Creates a new Queue Pair with the specified QP type. The Queue Pair
   * will be in the RESET state.
   *
   * @param qp_type The type of Queue Pair to create (e.g., IBV_QPT_RC,
   * IBV_QPT_UC).
   */
...
public:
  ...
  /**
   * @brief Construct a new qp object with the specified QP type. The
   * constructed Queue Pair will be in INIT state.
   *
   * @param pd The protection domain of the new Queue Pair.
   * @param cq The completion queue of both send and recv work completions.
   * @param qp_type The type of Queue Pair to create (e.g., IBV_QPT_RC,
   ...
   * SRQ.
   */
  qp(std::shared_ptr<pd> pd, std::shared_ptr<cq> cq, enum ibv_qp_type qp_type,
     std::shared_ptr<srq> srq = nullptr);
  ...
  /**
   * @brief Construct a new qp object with the specified QP type. The Queue Pair
   * will be created with the given remote Queue Pair parameters. Once
   * constructed, the Queue Pair will be in the RTS state.
   *
   * @param remote_lid The LID of the remote Queue Pair.
   * @param remote_qpn The QPN of the remote Queue Pair.
   * @param remote_psn The PSN of the remote Queue Pair.
